...
export default function PinScreen({ onSuccess }: PinScreenProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center"
      ...
      {/* Logo */}
      <div className="w-20 h-20 rounded-[22px] overflow-hidden mb-6 relative animate-glow"
        style={{ 
      ...
      {loading && (
        <div className="text-[11px] text-muted-foreground mb-4 animate-pulse-subtle">Connexion...</div>
      )}
