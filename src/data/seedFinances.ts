...
export const seedFinanceEntries: FinanceEntry[] = [
  ...
  { id: "seed-j07", month: "2026-01", type: "micro", label: "JM PASS SAP DOMICILE", amount: 240, offre: "JM PASS COACHING", clientName: "Crystelle SCARLATA", paymentMode: "cb", sapHours: 4 },
  { id: "seed-j08", month: "2026-01", type: "micro", label: "JM PASS SAP DOMICILE", amount: 240, offre: "JM PASS COACHING", clientName: "David ICARRE", paymentMode: "cb", sapHours: 4 },
  { id: "seed-j09", month: "2026-01", type: "micro", label: "JM PASS SAP DOMICILE", amount: 240, offre: "JM PASS COACHING", clientName: "Yann MONGABURU", paymentMode: "cb", sapHours: 4 },
  { id: "seed-j10", month: "2026-01", type: "micro", label: "JM PASS SAP DOMICILE", amount: 120, offre: "JM PASS COACHING", clientName: "Audrey CIMADOMO", paymentMode: "cb", sapHours: 2 },
  { id: "seed-j11", month: "2026-01", type: "micro", label: "JM PASS SAP DOMICILE", amount: 240, offre: "JM PASS COACHING", clientName: "Alice DIDIER", paymentMode: "cb", sapHours: 4 },
  ...
  { id: "seed-f02", month: "2026-02", type: "micro", label: "JM PASS SAP DOMICILE", amount: 300, offre: "JM PASS COACHING", clientName: "Crystelle SCARLATA", paymentMode: "cb", sapHours: 5 },
  { id: "seed-f03", month: "2026-02", type: "micro", label: "JM PASS SAP DOMICILE", amount: 240, offre: "JM PASS COACHING", clientName: "Arnaud ETITIA", paymentMode: "cb", sapHours: 4 },
  ...
  { id: "seed-f06", month: "2026-02", type: "micro", label: "JM PASS SAP DOMICILE", amount: 180, offre: "JM PASS COACHING", clientName: "Alice DIDIER", paymentMode: "cb", sapHours: 3 },
  { id: "seed-f07", month: "2026-02", type: "micro", label: "JM PASS SAP DOMICILE", amount: 240, offre: "JM PASS COACHING", clientName: "Yann MONGABURU", paymentMode: "cb", sapHours: 4 },
  { id: "seed-f08", month: "2026-02", type: "micro", label: "JM PASS SAP DOMICILE", amount: 240, offre: "JM PASS COACHING", clientName: "David ICARRE", paymentMode: "cb", sapHours: 4 },
  { id: "seed-f09", month: "2026-02", type: "micro", label: "JM PASS SAP DOMICILE", amount: 120, offre: "JM PASS COACHING", clientName: "Audrey CIMADOMO", paymentMode: "cb", sapHours: 2 },
